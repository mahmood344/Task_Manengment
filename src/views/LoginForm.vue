                ...
                <v-card class="login-card rounded-xl" max-width="500">
                  ...
                  <v-card-text>
                    <v-row>
                      ...
                      <v-col cols="12">
                        <v-btn dark color="purple darken-2" v-on:click="loginUser()" block>
                          LOGIN
    ...
    methods:{
      ...
      if(this.$refs.login.validate()){
        ...
        .catch((error) => {
          ...
          this.$store.dispatch('sendDataMessage', {message:error.response.data,status:error.response.status});
        });
      }
    },
    goToRegister(){
